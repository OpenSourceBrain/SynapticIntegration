...
Plot1.plotData(L23.popL23[0].Seg0_soma_0_0.v);
Plot1.setLegend(L23.popL23[0].Seg0_soma_0_0.v,"Soma");

Plot1.plotData(L23.popL23[0].Seg0_dend_21_264.v);
Plot1.setLegend(L23.popL23[0].Seg0_dend_21_264.v,"Basal - prox");
Plot1.plotData(L23.popL23[0].Seg40_dend_27_340.v);
Plot1.setLegend(L23.popL23[0].Seg40_dend_27_340.v,"Basal - dist");
